...
set_property PACKAGE_PIN U16 [get_ports {XA[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {XA[0]}]
set_property PACKAGE_PIN E19 [get_ports {XA[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {XA[1]}]
set_property PACKAGE_PIN U19 [get_ports {XA[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {XA[2]}]
set_property PACKAGE_PIN V19 [get_ports {XA[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {XA[3]}]
set_property PACKAGE_PIN W18 [get_ports {XB[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {XB[0]}]
set_property PACKAGE_PIN U15 [get_ports {XB[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {XB[1]}]
set_property PACKAGE_PIN U14 [get_ports {XB[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {XB[2]}]
set_property PACKAGE_PIN V14 [get_ports {XB[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {XB[3]}]
